...
def miss_ships():
    g = battleship.load_grid_from_file('grid1.txt')
    res = g.shoot((1,1))
...
def test_shoot_grid():
    ...
    v = [(('MISS', None), {'x_size': 5, 'y_size': 5, 'ships': [battleship.Ship('Destroyer', {(1, 2), (2, 2)})], 'misses': {(1, 1)}}),
         (('HIT', None), {'x_size': 5, 'y_size': 5, 'ships': [hit_once], 'misses': set()}),
         (('DESTROYED', hit_twice), {'x_size': 5, 'y_size': 5, 'ships': [hit_twice], 'misses': set()})
        ]
    generic_value_tester(f, v)
